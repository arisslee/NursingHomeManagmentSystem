...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new vn.thuanpm.face_detection.FaceDetectionPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin face_detection, vn.thuanpm.face_detection.FaceDetectionPlugin", e);
    }
    try {
